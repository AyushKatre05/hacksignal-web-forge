...
const Hero = () => {
  ...
  return (
    <section 
      id="home" 
      ref={heroRef}
      className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-hackSignal"
    >
      {/* Background elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full opacity-5 bg-hero-pattern bg-cover"></div>
        <div className="absolute -top-24 -right-24 w-96 h-96 bg-hackSignal-green opacity-10 rounded-full blur-3xl parallax"></div>
        <div className="absolute top-1/2 -left-24 w-80 h-80 bg-hackSignal-green-dark opacity-10 rounded-full blur-3xl parallax"></div>
        <div className="absolute -bottom-24 right-1/3 w-64 h-64 bg-hackSignal-green-light opacity-10 rounded-full blur-3xl parallax"></div>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-8">
            <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
              <div className="inline-block bg-hackSignal-light/20 backdrop-blur-sm border border-hackSignal-green/30 rounded-full px-4 py-2 mb-6">
                <p className="text-sm text-gray-300">
                  <span className="text-hackSignal-green font-medium">New:</span> Introducing our Generative AI Solutions
                </p>
              </div>
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4">
                <a href="#order" className="bg-hackSignal-green hover:bg-hackSignal-green-dark text-black font-medium px-8 py-3 rounded-lg transition-all hover:shadow-lg hover:shadow-hackSignal-green/20 focus:ring-2 focus:ring-hackSignal-green focus:ring-offset-2 focus:ring-offset-hackSignal-dark">
                  Order Your Solution
                </a>
                <a href="#join" className="bg-transparent border border-hackSignal-green/50 hover:border-hackSignal-green text-hackSignal-green font-medium px-8 py-3 rounded-lg transition-all hover:bg-hackSignal-green/10">
                  Join Our Team
                </a>
              </div>
            </div>
          ...
          <div className={`lg:col-span-5 transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100' : 'opacity-0 translate-x-10'}`}>
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-hackSignal-green/20 to-hackSignal-green-dark/20 rounded-2xl blur-xl"></div>
              <div className="glass-card p-1 relative">
                ...
                <div className="absolute -bottom-6 -right-6 glass-card p-4 animate-float">
                  <div className="text-sm font-medium text-hackSignal-green">AI-Powered Solutions</div>
                ...
                <div className="absolute -top-6 -left-6 glass-card p-4 animate-float" style={{ animationDelay: '2s' }}>
                  <div className="text-sm font-medium text-hackSignal-green">Cyber Security</div>
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
          <a href="#about" className="flex flex-col items-center text-gray-400 hover:text-hackSignal-green transition-colors">
